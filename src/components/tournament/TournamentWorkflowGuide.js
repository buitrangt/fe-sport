  ...
  const steps = [
    {
      ...
      description: "Nhập điểm cho từng trận đấu trong vòng hiện tại",
      icon: Save,
      status: remainingMatches > 0 ? 'current' : 'completed',
      details: [
        "Nhấp vào nút 'Nhập Điểm' cho mỗi trận đấu",
        "Nhập điểm của các đội (phải khác nhau - không hòa)",
        "Nhấp vào 'Lưu' để xác nhận kết quả",
        "Trạng thái trận đấu sẽ thay đổi thành ĐÃ HOÀN THÀNH"
      ]
    },
    {
      id: 2,
      title: "Hoàn Thành Vòng Hiện Tại",
      description: "Hoàn tất tất cả các trận đấu trong vòng này",
      icon: CheckCircle,
      status: remainingMatches === 0 ? 'completed' : 'pending',
      details: [
        `Hoàn thành ${remainingMatches} trận đấu còn lại`,
        "Tất cả các trận đấu phải có người thắng được xác định",
        "Tiến độ vòng đấu sẽ hiển thị 100%",
        "Sẵn sàng chuyển sang vòng tiếp theo"
      ]
    },
    {
      id: 3,
      title: "Chuyển Vòng",
      description: "Đưa những người thắng cuộc vào vòng tiếp theo",
      icon: ArrowRight,
      status: remainingMatches === 0 ? 'current' : 'pending',
      details: [
        "Đi đến tab 'Quản lý Vòng đấu'",
        "Nhấp vào nút 'Chuyển sang Vòng X'",
        "Hệ thống tự động tạo các trận đấu mới",
        "Những người thắng cuộc trở thành người tham gia vòng tiếp theo"
      ]
    },
    {
      id: 4,
      title: "Lặp lại cho đến Chung kết",
      description: "Tiếp tục cho đến khi giải đấu hoàn tất",
      icon: Trophy,
      status: 'pending',
      details: [
        "Lặp lại các bước 1-3 cho mỗi vòng",
        "Mỗi vòng có ít đội hơn",
        "Vòng cuối cùng xác định người thắng cuộc",
        "Trạng thái giải đấu trở thành ĐÃ HOÀN THÀNH"
      ]
    },
    {
      id: 5,
      title: "Tuyên bố Người Chiến Thắng",
      description: "Chúc mừng nhà vô địch giải đấu",
      icon: Crown,
      status: 'pending',
      details: [
        "Trận chung kết xác định nhà vô địch",
        "Người thắng cuộc được tự động tuyên bố",
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm text-gray-600">
                Đã hoàn thành {completedMatches}/{totalMatches} trận
              </span>
            </div>
                ...
                {remainingMatches > 0 ? (
                  <div>
                    <p className="text-orange-700 mb-2">
                      <strong>🎯 Nhập kết quả trận đấu:</strong> Còn {remainingMatches} trận cần nhập điểm
                    </p>
                    <p className="text-sm text-orange-600">
                      Đi đến tab "Kết Quả Trận Đấu" và nhấp vào "Nhập Điểm" cho mỗi trận đấu đang chờ.
                    </p>
                  </div>
                ) : (
                  <div>
                    ...
                    <p className="text-sm text-orange-600">
                      Đi đến tab "Quản lý Vòng đấu" và nhấp vào "Chuyển sang Vòng {currentRound + 1}".
                    </p>
                  </div>
                )}
              </div>
